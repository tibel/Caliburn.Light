...
public static class Coroutine
{
    ...
    public static Task ExecuteAsync(this ICoTask coTask, CommandExecutionContext? context = null)
    {
    ...
    /// <param name="context">The context to execute the coroutine within.</param>
    /// <returns>A task that represents the asynchronous coroutine.</returns>
    public static Task<TResult> ExecuteAsync<TResult>(this ICoTask<TResult> coTask, CommandExecutionContext? context = null)
    {
        return InternalExecuteAsync<TResult>(coTask, context);
    }

    private static Task<TResult> InternalExecuteAsync<TResult>(ICoTask coTask, CommandExecutionContext? context)
    {
        var taskSource = new TaskCompletionSource<TResult>();

        void completed(object? s, CoTaskCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                taskSource.TrySetResult(rr is not null ? rr.Result : default!);
            }
        }
        ...
        try
        {
            ...
            coTask.BeginExecute(context ?? new CommandExecutionContext());
        }
        catch (Exception ex)
        {
            coTask.Completed -= completed;
    ...
    /// <returns></returns>
    public static ICoTask<TResult> OverrideCancel<TResult>(this ICoTask<TResult> coTask, TResult cancelResult)
    {
    ...
    /// <returns></returns>
    public static ICoTask Rescue<TException>(this ICoTask coTask, Func<TException, ICoTask> rescue, bool cancelCoTask = true)
    ...
    /// <param name="cancelCoTask">Set to true to cancel the CoTask after executing rescue.</param>
    /// <returns></returns>
    public static ICoTask Rescue(this ICoTask coTask, Func<Exception, ICoTask> rescue, bool cancelCoTask = true)
    {
